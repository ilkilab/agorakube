...
- [Qu'est-ce qu'Agorakube](#what-is-agoraKube)
- [Comment l'installer](#how-to-install)
- [Comment nous faire des retours](#how-to-give-feedback)
...
Ce projet est actuellement en cours de développement et d'autres options de customisation seront bientôt disponibles.
...
Vous pouvez également remonter les failles de sécuritée par ces moyens.
...
- **#developpers** - Pour les contributeurs d'Agorakube qui dévelloppent de nouvelles fonctionnalités
...
Tout contenu non exécutable, incluant tout texte quand il n'est pas éxécuté est également délivré sous la licence APACHE 2.0.
En termes SPDX, tout le contenu est sous licence APACHE 2.0;
si ce contenu n'est pas executable, incluant le texte extrait du code, c'est "(APACHE 2.0)".

Comme presque tout logiciel aujourd'hui, ce logicicel dépend d'autre composants ayant leur propre licences. Les composants donc nous dépendont ne sont pas tous sous licence APACHE 2.0, mais tous les composant *requis* sont sous licences de type FLOSS. Nous prévenons les problèmes de licence à l'aide de différent processus (voir [Contribuer](./docs/CONTRIBUTING.md))
