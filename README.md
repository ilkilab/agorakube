...
You need to install on your computer [VirtualBox](https://www.virtualbox.org/wiki/Downloads) and [Vagrant](vagrantup.com/downloads) tools then download "[Vagrantfile](./labs/multi-nodes/Vagrantfile)" file.
